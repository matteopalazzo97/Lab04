...
public class Corso implements Comparable<Corso> {
	...
	private String codins;	// codice identificativo del corso
	private String nome;	// nome del corso
	private int crediti;	// crediti del corso
	private int pd; 		// periodo didattico
	
	
	/**
	 * Costruttore da codins
	 * @param codins
	 */
	...
	/**
	 * Costruttore con tutte le informazioni del corso
	 * @param codins
	 * @param nome
	 * @param crediti
	 * @param pd
